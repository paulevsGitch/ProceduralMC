...
public class MarkovChain {
	...
	public String toString() {
		...
		for (MarkovElement elem : elements) {
			n++;
			result += "\n  \"" + elem.str + " tp:" + elem.totalProb + "\": {";
			int count2 = elem.next.size();
			int n2 = 0;
			for (MarkovElement e : elem.next) {
				n2++;
				result += (n2 == 1 ? "\"" : " \"") + e.str + " p:" + e.prob.get(elem) + "\"";
				if (n2 < count2) {
					result += ",";
				}
			}
	...
	private class MarkovElement {
		List<MarkovElement> next = new ArrayList<MarkovElement>();
		Map<MarkovElement, Integer> prob = new HashMap<MarkovElement, Integer>();
		int totalProb;
		String str;
		...
		public boolean equals(Object obj) {
			...
			return element == null ? false : element == this ? true : element.str.equals(this.str);
		}
	}
}
